...
export CLASS_LIBRARY_PROJ_DIR=source/Otc.PdfTemplate.Abstractions
export TEST_PROJ_DIR=source/Otc.PdfTemplate.Tests
...
export CLASS_LIBRARY_PROJ_DIR=source/Otc.PdfTemplate
